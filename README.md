...
![](http://nsa38.casimages.com/img/2016/09/01/160901040338228619.png)
...
*Si la LED verte d'allume, alors la connection à notre serveur est faite ! En revanche, si la LED rouge s'allume, cela signifie que vous n'avez pas créé votre compte ou bien simplement mal recopié vos identidiants dans le fichier "api.h". Rêgler le problème, puis appuyez de nouveau sur le bouton "Téléverser".
